package com.Website.WebBanHang;

import com.Website.WebBanHang.Service.UserService;
        ...
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/", "/oauth/**",
                                "/register", "/error", "/product", "/cart", "/cart/**")
                        .permitAll() // Cho phép truy cập không cần xác thực.
                                .requestMatchers("/product/edit/**", "/product/add",
                                        "/product/delete","/categories/add","/categories","/categories/edit/**","/categories/delete")
